        ...
        RootRef.child("Messages").child(messageSenderID).child(messageReceiverID)
                .addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                        ...
                        for(int z =0 ;z<messagesList.size();z++)
                        {
                            System.out.println(messagesList.get(z).getMessageID());
                        }
                        ...
                        if(messagesListHash.containsKey(messages.getMessageID()))
                        {
                            ...
                            {
                                //System.out.println(messagesList.get(z).getMessageID());
                                //System.out.println(messagesList.get(z).getMessageID()+"=="+messages.getMessageID());
                                if(messagesList.get(z).getMessageID().equals(messages.getMessageID()) )
                                {
                                    //System.out.println(messagesList.get(z).getMessage()+"!="+messages.getMessage());
                                    if(!messagesList.get(z).getMessage().equals(messages.getMessage()))
                                    {
                                        //System.out.println("here");
                                        messagesList.set(z,messages);
                                    }
                                    break;
                                }
                            }

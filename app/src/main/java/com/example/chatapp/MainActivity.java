        ...
        RootRef.child("Groups").child(groupName).setValue("")
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        {
                            RootRef.child("GroupsMembers").child(groupName).child("admin").setValue(currentUserID)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task)
                                        {
                                                ...
                                                RootRef.child("GroupsMembers").child(groupName).child("members").setValue(memberList)
                                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task)
                                                            {
                                                                ...
                                                                {
                                                                    Toast.makeText(MainActivity.this, groupName + " Error Creating Group...", Toast.LENGTH_SHORT).show();

                            ...
                            public void onDataChange(DataSnapshot dataSnapshot)
                            {
                                if (dataSnapshot.exists())
                                {
                                        ...
                                        UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot)
                                            {
                                                ...
                                                holder.CancelButton.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    AlertDialog.Builder builder = new AlertDialog.Builder(getContext(),R.style.AlertDialogTheme);
                                                    builder.setTitle("Decline Friend Request");
                                                    builder.setMessage("Are You Sure?");
                                                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                                        public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    else if (type.equals("sent"))
                                    {
                                        ...
                                        request_accept_btn.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.button_red));
                                        request_accept_btn.setText("Cancel");
                                        ...
                                        UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot)
                                            {
                                                ...
                                                holder.userName.setText(requestUserName);
                                                holder.userStatus.setText("Request sent fto " + requestUserName);
